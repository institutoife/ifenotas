...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .whatsapp-float{position:fixed;right:18px;bottom:18px;z-index:40;width:58px;height:58px;border-radius:50%;display:grid;place-items:center;background:#25d366;color:#fff;text-decoration:none;box-shadow:0 14px 30px rgba(37,211,102,.35);transition:transform .2s ease,box-shadow .2s ease}
    .whatsapp-float:hover{transform:translateY(-3px) scale(1.04);box-shadow:0 18px 34px rgba(37,211,102,.42)}
    .whatsapp-float i{font-size:2rem;line-height:1}
    @media(max-width:760px){.grid,.wide-grid,.service-grid,.hero,.social-card{grid-template-columns:1fr}.author{max-width:220px}.social-author{width:150px;height:150px}.whatsapp-float{right:14px;bottom:14px;width:54px;height:54px}}
  </style>
</head>
<body>
  ...
  <a class="whatsapp-float" href="https://wa.me/59171324941?text=Hola%2C%20quiero%20mas%20informacion" target="_blank" rel="noopener" aria-label="Escribir por WhatsApp">
