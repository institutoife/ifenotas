...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;font-family:"Segoe UI",Arial,sans-serif;color:var(--text);background:var(--bg);line-height:1.45}a{color:inherit}img{max-width:100%}.wrap{width:min(1160px,100%);margin:auto;padding-inline:16px}
        ...
        .visitor-counter{display:inline-flex;align-items:center;gap:9px;margin-top:13px;border:2px solid var(--line);border-radius:999px;background:#fff;padding:7px 13px;color:var(--secondary);box-shadow:0 7px 18px rgba(55,95,122,.09)}.visitor-counter i{color:var(--primary)}.visitor-counter strong{font-size:1.08rem}.visitor-counter span{font-size:.78rem;font-weight:800}
            ...
            <div class="hero">
                <div class="hero-grid">
                    <div class="hero-copy">
                        ...
                        <h1>IFE NOTAS</h1>
                        <div class="visitor-counter" aria-label="Contador de visitas"><i class="fa-solid fa-users"></i><strong>{{ number_format($visitorCount, 0, ',', '.') }}</strong><span>personas visitaron esta p&aacute;gina</span></div>
