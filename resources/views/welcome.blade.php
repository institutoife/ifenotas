  ...
  <main class="container">
    ...
    <section class="grid section">
      ...
      <article class="item">
        ...
        <p>Si necesitas apoyo escolar, escríbenos desde nuestros perfiles oficiales.</p>
        <div class="actions" style="margin-top:12px;">
          <a class="btn btn-soft" href="https://www.tiktok.com/@ife_educabol" target="_blank" rel="noopener">Ver perfil</a>
        </div>
      </article>
    </section>
